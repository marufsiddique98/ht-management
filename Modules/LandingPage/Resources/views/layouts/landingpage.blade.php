@php
    ...
    $adminSettings = Utility::getAdminPaymentSettings();
    ...
    $get_cookie = Utility::getAdminPaymentSettings();
...
<head>
    ...
    <!-- font css -->
    <link rel="stylesheet" href=" {{ asset('public/landing_page_assets/fonts/tabler-icons.min.css') }}" />
    <link rel="stylesheet" href=" {{ asset('public/landing_page_assets/fonts/feather.css') }}" />
    <link rel="stylesheet" href="  {{ asset('public/landing_page_assets/fonts/fontawesome.css') }}" />
    <link rel="stylesheet" href="{{ asset('public/landing_page_assets/fonts/material.css') }}" />
    @if ($SITE_RTL == 'on')
    ...
    @else
        <link rel="stylesheet" href="{{ asset('public/landing_page_assets/css/style.css') }}" id="main-style-link">
    @endif

    <!-- vendor css -->
    {{-- <link rel="stylesheet" href="  {{ asset('public/landing_page_assets/css/style.css')}}" /> --}}
    <link rel="stylesheet" href=" {{ asset('public/landing_page_assets/css/customizer.css') }}" />
            ...
            <nav class="navbar navbar-expand-md  default top-nav-collapse">
                <div class="header-left">
                    <a class="navbar-brand bg-transparent" href="#">
                        <img src="{{ $logo . '/' . $settings['site_logo'] . '?v=' . time() }}" alt="logo"
                            class="">
                    </a>
                </div>
                ...
                <div class="ms-auto d-flex justify-content-end gap-2">
                    ...
                    @if ($adminSettings['signup_button'] == 'on')
                    ...
                    @if ($key % 2 == 0)
                        <div class="row align-items-center justify-content-center mb-4">
                            ...
                            <div class="col-lg-7 col-md-6 res-img">
                                <div class="{{ !empty($value['other_features_image']) ? 'img-wrapper' : '' }}">
                    ...
                    @foreach (json_decode($settings['screenshots'], true) as $value)
                        <div class="col-md-4 col-sm-6">
                            <div class="screenshot-card">
                                <div class="{{ !empty($value['screenshots'] ? 'img-wrapper' : '') }}">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price">@if (env('CURRENCY_SYMBOL') == null) {{ '$'.$value->monthly_price}} @else {{ env('CURRENCY_SYMBOL').$value->monthly_price }}  @endif <small
                                        class="text-sm">/ {{'Month'. $value->duration }}</small></span>
                                <p>
                                    {!! $value->description !!}
                                </p>
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->max_workspaces != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label" for="customCheckc1">{{ $value->max_workspaces }}
                                                Workspaces</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->max_users != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label" for="customCheckc1">{{ $value->max_users }}
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->max_projects != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_projects }}
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label" for="customCheckc1">{{ $value->storage_limit }}
                                                Storage Limit</label>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->enable_chatgpt == 'on' ? 'checked' : "" }}>
                                            <label class="form-check-label"
...
<script src="{{ asset('public/landing_page_assets/js/plugins/popper.min.js') }}"></script>
<script src="{{ asset('public/landing_page_assets/js/plugins/bootstrap.min.js') }}"></script>
<script src="{{ asset('public/landing_page_assets/js/plugins/feather.min.js') }}"></script>
